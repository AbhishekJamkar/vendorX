...
//		System.out.println("email user "+user.get().getEmail());
    ...
    @Override
    public List<User> getPenddingBusinessOwner() {

        return userRepository.getPenddingBusinessOwners();
    }
    ...
    public void sendPasswordResetEmail(User user) {
        ...
        sendEmail(user.getEmail(), "Password Reset", "Click the following link to reset your password: http://localhost:3000/LocalMarketplace/account/reset-password?token=" + resetToken);
    }

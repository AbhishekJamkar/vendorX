...
import Business from '../customers/pages/Business/Business'
  ...
  return (
    <div className='relative'>
        ...
        <Routes>
            ...
            <Route exact path='/business/:city/:title/:id' element={<Business/>}/>
            <Route path='/cart' element={<Cart/>}/>
            <Route path='/payment/success/:id' element={<PaymentSuccess/>}/>
            <Route path='/my-profile/*' element={<Profile/>}/>
            <Route path='/search' element={<Search/>}/>
            <Route path='/admin/add-business' element={<CreateBusinessForm/>}/>

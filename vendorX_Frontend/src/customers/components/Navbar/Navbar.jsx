...
const Navbar = () => {
  ...
  const navigateToProfile = (e) => {
    ...
    } else if (auth.user?.role === "ROLE_BUSINESS_OWNER") {
  ...
  return (
    <div className="px-5 z-50 py-[.8rem] bg-[#7700ff]  lg:px-20 flex justify-between">
      <div className="flex items-center space-x-4">
        ...
        > {/* Logo Image */}
          <img
            ...
            alt="Logo"
            className="h-10 w-15 object-contain rounded-full"
          />
      ...
      <div className="flex items-center space-x-2 lg:space-x-10">
        ...
        <div className="flex items-center space-x-2">
          {auth.user?.fullName ? (
            ...
            >
              <Avatar sx={{ bgcolor: "white", color: "#7700ff" }} className="bg-white">

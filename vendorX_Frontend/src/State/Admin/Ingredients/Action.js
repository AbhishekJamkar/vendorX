...
export const getIngredientsOfBusiness = ({id,jwt}) => {
  return async (dispatch) => {
    try {
      const response = await api.get(`/api/admin/ingredients/business/${id}`,{
        headers: {
...
export const getIngredientCategory = ({id,jwt}) => {
  return async (dispatch) => {
    try {
      const response = await api.get(`/api/admin/ingredients/business/${id}/category`,{
        headers: {
          Authorization: `Bearer ${jwt}`,
        },
      });

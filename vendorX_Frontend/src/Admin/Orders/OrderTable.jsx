...
import {
  ...
  updateOrderStatus,
} from "../../State/Admin/Order/businesses.order.action";
// import {
//   confirmOrder,
//   deleteOrder,
//   deliveredOrder,
...
const OrdersTable = ({ isDashboard, name }) => {
  ...
  const { businessesOrder } = useSelector((store) => store);
  ...
  // console.log("businesses orders store ", businessesOrder)
          ...
          <Table sx={{}} aria-label="table in dashboard">
            <TableHead>
              ...
              <TableCell>Id</TableCell>
                ...
                {!isDashboard && <TableCell>Quantity</TableCell>}
            ...
            <TableBody>
              {businessesOrder.orders
                ?.slice(0, isDashboard ? 7 : businessesOrder.orders.length)
                .map((item, index) => (
                  <TableRow

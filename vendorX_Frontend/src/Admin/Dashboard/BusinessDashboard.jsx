...
import MenuItemTable from "../Products/MenuItemTable";
      ...
      <Grid container spacing={1}>
        ...
        <Grid item lg={3} xs={12}>
          <AvgCard
            ...
            value={`${299}`}
            growValue={30}
            icon={<Inventory2Icon sx={{ fontSize: "3rem", color: "blue" }} />}
          />
        </Grid>
        <Grid item lg={3} xs={12}>
          <AvgCard
            ...
            value={`${1}`}
            growValue={10}
            icon={<Inventory2Icon sx={{ fontSize: "3rem", color: "red" }} />
        ...
        <Grid lg={6} xs={12} item>
          <MenuItemTable isDashboard={true} name={"Recently Added Product"} />
        </Grid>
      </Grid>
    </div>
  );
